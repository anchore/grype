...
func init() {
	...
	var explicitIgnores = []ignoreValues{
		// Based on https://github.com/nextlinux/griffon/issues/552, which includes a reference to the
		...
		// Based on https://github.com/nextlinux/griffon/issues/558:
		{
			typ:             "go-module",
...
// ApplyExplicitIgnoreRules Filters out matches meeting the criteria defined above and those within the griffon database
