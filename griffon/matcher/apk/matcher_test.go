...
func TestSecDBOnlyMatch(t *testing.T) {
	...
	secDbVuln := griffonDB.Vulnerability{
	...
	store := mockStore{
		backend: map[string]map[string][]griffonDB.Vulnerability{
			"secdb:distro:alpine:3.12": {
				"libvncserver": []griffonDB.Vulnerability{secDbVuln},
			},
		},
	}
...
func TestBothSecdbAndNvdMatches(t *testing.T) {
	...
	nvdVuln := griffonDB.Vulnerability{
		ID:                "CVE-2020-1",
		VersionConstraint: "<= 0.9.11",
	...
	store := mockStore{
		backend: map[string]map[string][]griffonDB.Vulnerability{
			"nvd:cpe": {
				"libvncserver": []griffonDB.Vulnerability{nvdVuln},
			},
			"secdb:distro:alpine:3.12": {
				"libvncserver": []griffonDB.Vulnerability{secDbVuln},
			},
...
func TestBothSecdbAndNvdMatches_DifferentPackageName(t *testing.T) {
	...
	store := mockStore{
		backend: map[string]map[string][]griffonDB.Vulnerability{
			"nvd:cpe": {
				"libvncumbrellaproject": []griffonDB.Vulnerability{nvdVuln},
			},
			"secdb:distro:alpine:3.12": {
				"libvncserver": []griffonDB.Vulnerability{secDbVuln},
			},
...
func TestNvdMatchesProperVersionFiltering(t *testing.T) {
	nvdVulnMatch := griffonDB.Vulnerability{
		ID:                "CVE-2020-1",
		VersionConstraint: "<= 0.9.11",
		VersionFormat:     "unknown",
		CPEs:              []string{`cpe:2.3:a:lib_vnc_project-\(server\):libvncserver:*:*:*:*:*:*:*:*`},
	...
	nvdVulnNoMatch := griffonDB.Vulnerability{
		ID:                "CVE-2020-2",
		VersionConstraint: "< 0.9.11",
		VersionFormat:     "unknown",
		CPEs:              []string{`cpe:2.3:a:lib_vnc_project-\(server\):libvncserver:*:*:*:*:*:*:*:*`},
	...
	store := mockStore{
		backend: map[string]map[string][]griffonDB.Vulnerability{
			"nvd:cpe": {
				"libvncserver": []griffonDB.Vulnerability{nvdVulnMatch, nvdVulnNoMatch},
			},
		},
	}
...
func TestDistroMatchBySourceIndirection(t *testing.T) {
	...
	store := mockStore{
		backend: map[string]map[string][]griffonDB.Vulnerability{
			"secdb:distro:alpine:3.12": {
				"musl": []griffonDB.Vulnerability{secDbVuln},
			},
		},
	}
...
func TestNVDMatchBySourceIndirection(t *testing.T) {
	...
	store := mockStore{
		backend: map[string]map[string][]griffonDB.Vulnerability{
			"nvd:cpe": {
				"musl": []griffonDB.Vulnerability{nvdVuln},
			},
		},
	}
