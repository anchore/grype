...
func TestVersionDpkg_Basic(t *testing.T) {
	tests := []testCase{
...
func TestVersionDpkg_Metadata(t *testing.T) {
	tests := []testCase{
...
func TestVersionDpkg_Java(t *testing.T) {
	tests := []testCase{
...
func TestVersionDpkg_Chrome(t *testing.T) {
	tests := []testCase{
