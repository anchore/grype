...
import (
	...
	"github.com/anchore/grype/internal/db/v5/pkg/qualifier/platformcpe"
)
		...
		},
		{
			...
			metadata: v5.VulnerabilityMetadata{
				...
				Cvss: []v5.Cvss{
					{
						VendorMetadata: nil,
						Metrics:        v5.NewCvssMetrics(10, 10, 10),
					...
					{
						VendorMetadata: nil,
						Metrics:        v5.NewCvssMetrics(10, 3.9, 6),
		...
		},
		{
			...
			metadata: v5.VulnerabilityMetadata{
				...
				Cvss: []v5.Cvss{
					{
						VendorMetadata: nil,
						Metrics:        v5.NewCvssMetrics(4.3, 2.8, 1.4),
		...
		},
		{
			...
			metadata: v5.VulnerabilityMetadata{
				...
				Cvss: []v5.Cvss{
					{
						VendorMetadata: nil,
						Metrics:        v5.NewCvssMetrics(7.5, 3.9, 3.6),
		...
		t.Run(test.name, func(t *testing.T) {
			...
			for _, entry := range entries {
				...
				for _, entry := range dataEntries {
					...
					case v5.Vulnerability:
						vulns = append(vulns, vuln)
					case v5.VulnerabilityMetadata:
						// check metadata
