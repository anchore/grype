...
import (
	...
	"github.com/anchore/grype/internal/db/v5/store"
	"github.com/anchore/grype/internal/file"
	"github.com/anchore/grype/internal/log"
)

const (
	FileName                = v6.VulnerabilityStoreFileName
...
func NewCurator(cfg Config) (Curator, error) {
	dbDir := path.Join(cfg.DBRootDir, strconv.Itoa(v6.SchemaVersion))
...
func (c *Curator) GetStore() (v6.StoreReader, error) {
	// ensure the DB is ok
