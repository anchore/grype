...
func TestVersionRpmConstraint(t *testing.T) {
	tests := []testCase{
		...
		{version: "1:0", constraint: "< 1", satisfied: false},
		...
		{version: "2:4.19.01-1.el7_5", constraint: "<= 4.19.1-1.el7_5", satisfied: false},
		{version: "4.19.01-1.el7_5", constraint: "< 2:4.19.1-1.el7_5", satisfied: true},
		{version: "0:4.19.1-1.el7_5", constraint: "< 2:4.19.1-1.el7_5", satisfied: true},
		{version: "4.19.0-1.el7_5", constraint: "< 12:4.19.0-1.el7", satisfied: true},
		{version: "4.19.0-1.el7_5", constraint: "<= 12:4.19.0-1.el7", satisfied: true},
		...
		{version: "3:4.19.0-1.el7_5", constraint: "< 4.21.0-1.el7", satisfied: false},
