...
// Test fixtures for grype's override application behavior tests.
// These provide reference data to verify that grype correctly applies
// whatever overrides it finds in databases built by grype-db.

// testOperatingSystemSpecifierOverrides returns OS aliases for testing grype's matching behavior.
// NOTE: In production, this data is managed by grype-db during database construction.
func testOperatingSystemSpecifierOverrides() []OperatingSystemSpecifierOverride {
