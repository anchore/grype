...
// NewMockProvider returns a new mock implementation of a Grype database store. If
...
// func (s *MockProvider) Add(vulns ...vulnerability.Vulnerability) *MockProvider {
//	s.Vulnerabilities = append(s.Vulnerabilities, vulns...)
//	return s
//}

// func (s *MockProvider) GetVulnerabilityMatchExclusion(id string) ([]VulnerabilityMatchExclusion, error) {
//	if s.Exclusions == nil {
//		return nil, nil
//	}
...
// func (s *MockProvider) GetVulnerability(namespace, id string) ([]Vulnerability, error) {
...
// func (s *MockProvider) SearchForVulnerabilities(namespace, name string) ([]Vulnerability, error) {
...
// func (s *MockProvider) GetAllVulnerabilities() (*[]Vulnerability, error) {
...
// func (s *MockProvider) VulnerabilityNamespaces() ([]string, error) {
//	var namespaces []string
//	for _, vuln := range s.Vulnerabilities {
//		if slices.Contains(namespaces, vuln.Namespace) {
//			continue
//		}
//		namespaces = append(namespaces, vuln.Namespace)
//	}
