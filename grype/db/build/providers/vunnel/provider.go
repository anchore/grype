...
func NewProvider(root string, id provider.Identifier, cfg Config) provider.Reader {
...
func GenerateConfigs(root string, cfg Config) ([]pull.ProviderRunConfig, error) {
	...
	var cfgs []pull.ProviderRunConfig
