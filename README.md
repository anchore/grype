...
gtime -v grype sbom:~/Downloads/sbom_virtual_machine_72891.json -o json --by-cve > grype.json 2> old.txt
gtime -v -o new-3.txt new-grype sbom:~/Downloads/sbom_virtual_machine_72891.json --drop-ignored-matches -o json --by-cve > grype.json